                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-12">
                    <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-sm">
                            Innovative engineering in embedded systems, IoT, power systems, electrical machines, and software solutions.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link to="/#ai-division" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">AI Division</Link></li>
                            <li><Link to="/#work" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Work</Link></li>
                            <li><Link to="/#skills" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Expertise</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="https://blogs.rsmk.me" target="_blank" rel="noopener noreferrer" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Insights Blog</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="text-slate-600 dark:text-slate-400">Collaborate with our systems engineering team</li>
